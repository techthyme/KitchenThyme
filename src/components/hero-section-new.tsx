          ...
          <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              ...
              <h1 className="mt-10 text-5xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-7xl">
                Professional Kitchen Spaces in the Virgin Islands
              </h1>
              <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
                Book licensed commercial kitchen space by the hour for your ghost kitchen, catering business, or meal prep service. Fully equipped with Caribbean cooking essentials and flexible scheduling to grow your food business.
              </p>
              <div className="mt-10 flex items-center gap-x-6">
                ...
                <a href="#" className="text-sm/6 font-semibold text-gray-900">
                  Tour Kitchens <span aria-hidden="true">→</span>
                </a>
              </div>
            </div>
