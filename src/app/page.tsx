    ...
    <div className="bg-white dark:bg-gray-900">
      ...
      <div className="relative isolate overflow-hidden pt-14">
        ...
        <img
          ...
          className="hidden -absolute inset-0 -z-10 size-full object-cover opacity-10 dark:hidden"
        />
        <div
          aria-hidden="true"
          className="hidden -absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80"
        >
          <div
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              ...
              <p className="mt-8 text-lg font-medium text-pretty text-white sm:text-xl/8 -dark:text-gray-400">
                An entirely new way to experience and enjoy Virgin Islands
